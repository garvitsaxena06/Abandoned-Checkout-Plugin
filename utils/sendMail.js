...
const transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
    user: 'gupta.rahul51551@gmail.com',
    pass: 'cwqzgfhwahpckcmo',
  },
  port: 465,
  host: 'smtp.gmail.com',
})
...
export const sendMail = (options, cb = () => {}) => {
  ...
  const mailOptions = {
    from: 'Abandoned Checkout <gupta.rahul51551@gmail.com>',
    to: email,
    subject: 'E-commerce Business | You have an incomplete order in your cart',
    html: `<!DOCTYPE html>
    <html
      lang="en"
                  ...
                  >
                    <tr>
                      <td class="logo" style="text-align: left">
                        <h1><a href="#">E-commerce Business</a></h1>
                      </td>
                    </tr>
                  </table>
                </td>
                  ...
                  >
                    <tr>
                      <td style="padding: 0 2.5em; text-align: left">
                        <div class="text">
                          <h2>Hi user ${email}! <br> your shopping cart misses you</h2>
                          <h3>
                            Amazing deals, updates, interesting news right in your
                            inbox. Please checkout soon to avail limited offers.
                          </h3>
                        </div>
                      </td>
                    </tr>
                ...
                >
                  ...
                  <tr style="border-bottom: 1px solid rgba(0, 0, 0, 0.05)">
                    ...
                    >
                      <div class="product-entry">
                        <img
                          src="https://github.com/ColorlibHQ/email-templates/blob/master/12/images/prod-1.jpg?raw=true"
                          alt=""
                          style="
                            width: 100px;
                            max-width: 600px;
                  ...
                  <tr style="border-bottom: 1px solid rgba(0, 0, 0, 0.05)">
                    ...
                    >
                      <div class="product-entry">
                        <img
                          src="https://github.com/ColorlibHQ/email-templates/blob/master/12/images/prod-2.jpg?raw=true"
                          alt=""
                          style="
                            width: 100px;
                            max-width: 600px;
